(() => {
  ...
  let currentScene = 0; // 현재 활성화된 씬 (scoll section)
  let enterNewScene = false; //새로운 씬에 들어선 순간 true로 바뀜.
  let acc = 0.1;
  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      ...
      case 2:
        ...
        // currentScene 3에서 쓰는 canvas를 미리 그려주기 시작
        if (scrollRatio > 0.9) {
          ...
          // recalculated 값들은 주어진 기기의 screen 비율에 맞게 canvas size 설정
      ...
      case 3:
        ...
        if (!values.rectStartY) {
          ...
          values.rectStartY =
            ...
            (objs.canvas.height * (1 - canvasScaleRatio)) / 2;
          values.rect1X[2].start =
            window.innerHeight / 2 / sceneInfo[currentScene].scrollHeight;
          values.rect1X[2].end =
            values.rectStartY / sceneInfo[currentScene].scrollHeight;
        ...
        if (scrollRatio < values.rect1X[2].end) {
          ...
          if (
            ...
            objs.canvas.style.marginTop = `${
              sceneInfo[currentScene].scrollHeight * 0.4
            }px`;
